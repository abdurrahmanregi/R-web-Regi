...
\centerline{{\huge \name}}
\vspace{0.08in}
\centerline{\Large Research Statement}
\vspace{0.12in}
\begin{center}
{\small
Department of Economics, VU Amsterdam and Tinbergen Institute \\
Email: \href{mailto:r.kusumaatmadja@vu.nl}{r.kusumaatmadja@vu.nl} \quad
Website: \href{https://regikusumaatmadja.com}{https://regikusumaatmadja.com}
}
\end{center}
\vspace{0.08in}
